...
\begin{tikzpicture}[auto,node distance=4cm]
  ...
  \node[attribute] (endereço) [below left = 2cm of data nascimento] {Endereço} edge (pessoa);
...
%  \node[attribute] (remoção) [below = 1.5cm of serviço-tipo] {Remoção} edge (serviço-tipo);
  ...
  \node[attribute] (nota obtida) [right = 0.5cm of código disciplina] {Nota obtida} edge (rel3); 
  
  \node[attribute] (data início) [right = 0.5cm of nota obtida] {Data início} edge (rel3); 
